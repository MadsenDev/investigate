...
- Added durable Vitni 2 Findings with explicit assertion support links, reviewed/disputed/withdrawn states, report-readiness validation, audit history, and deterministic JSON/Markdown evidence bundles.
